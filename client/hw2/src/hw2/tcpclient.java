...
public class tcpclient {
	...
	public static void main(String args[]) {
		try {
			...
			thread1.start();
			clientPictureThread thread2 = new clientPictureThread();
			thread2.start();
			...
			JLabel t2 = new JLabel("Server IP:");
			p1_1.add(t2);
			p1_1.add(input1);

			JLabel t3 = new JLabel("Server Port:");
			p1_1.add(t3);
			p1_1.add(input2);
			p1.add(p1_1);
			...
			btn1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e3) {
					...
					if (flag == JFileChooser.APPROVE_OPTION) {
						...
						JLabel t1 = new JLabel("Client>>");
						tcpclient.p2.add(t1);
						JLabel t2 = new JLabel(new ImageIcon(imageIcon.getImage().getScaledInstance(-100, 180, java.awt.Image.SCALE_SMOOTH)));//調整圖片大小
						tcpclient.p2.add(t2);
			...
			btn2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e3) {
					...
					JLabel t2 = new JLabel("Client>>   " + split[0]);
					tcpclient.p2.add(t2);
